...
class AlertConfirmationBox(BasePage):
    def __init__(self, browser):
        super().__init__(browser)

    def open(self):
        return self.browser.get('https://www.qa-practice.com/elements/alert/confirm#')
...
######################
    ...
    def alert_accept(self):
        ...
        alert.accept()
        sucsess_message = self.browser.find_element(By.XPATH, '//p[contains(text(), "Ok")]')
    ...
    def alert_dissmiss(self):
        ...
        alert = Alert(self.browser)
        alert.dismiss()
        sucsess_message = self.browser.find_element(By.XPATH, '//p[contains(text(), "Cancel")]')
        sucsess_message.is_displayed()
